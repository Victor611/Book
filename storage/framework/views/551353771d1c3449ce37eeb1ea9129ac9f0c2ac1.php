                        ...
                        <!-- Обложка-->
                            ...
                            <div class="col-sm-12" style="padding-bottom:50px;">    
                                ...
                                <form action="/status" method="POST" style="display: inline;">
                                    ...
                                    <input type="hidden" name="book_id" value="<?php echo e($book->id); ?>">
                                    <input type="hidden" name="user_id" value="<?php echo e(Auth::user()->id); ?>">
                                    <button type="submit" class="<?php echo e(App\Status::hasStatus($book->id, Auth::user()->id) == 2?"btn btn-danger":"btn btn-default"); ?>">
                                ...
                                <form action="/status" method="POST" style="display: inline;">
                                    ...
                                    <input type="hidden" name="book_id" value="<?php echo e($book->id); ?>">
                                    <input type="hidden" name="user_id" value="<?php echo e(Auth::user()->id); ?>">
                                    <button type="submit" class="<?php echo e(App\Status::hasStatus($book->id, Auth::user()->id) == 3 ? "btn btn-danger" :"btn btn-default"); ?>">
                                ...
                                <div id="panel2" class="tab-pane fade">
                                    ...
                                    <div class="col-md-12">                           
                                        ...
                                        <?php foreach(App\Status::StatusToBook($book->id, "1")  as $k=>$v): ?>
                                            <a href="/user/<?php echo e($v->id); ?>">
                                                <div class="col-sm-3"><img src="/uploads/avatars/<?php echo e($v->avatar); ?>" style="width:100px; heidth:100px; float:left;">
                                                    <p>name: <?php echo e($v->name); ?></p>
                                                </div>
                                            </a>
                                        <?php endforeach; ?>
                                    </div>
