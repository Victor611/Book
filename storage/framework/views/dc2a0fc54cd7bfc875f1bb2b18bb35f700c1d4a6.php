                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <?php foreach($genres as $g): ?>
                                        ...
                                        <option value ='<?php echo e($g->id); ?>' <?php if($g->id == $book->genre->id): ?> selected <?php endif; ?>><?php echo e($g->name); ?></option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <select  class="form-control" name="type">
                                        <option value ='Бумажная' <?php if($book->type == 'Бумажная'): ?> selected <?php endif; ?>>Бумажная</option>
                                        <option value ='Электронная'<?php if($book->type == 'Электронная'): ?> selected <?php endif; ?>>Электронная</option>
                                    </select>
                                </div>
                            </div>   
