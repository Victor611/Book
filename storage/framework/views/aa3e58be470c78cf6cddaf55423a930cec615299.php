        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-nav">
                    <li><a href="<?php echo e(url('/moder/book')); ?>">Книги</a></li>
                    <li><a href="<?php echo e(url('/moder/user')); ?>">Пользователи</a></li>
                    <li><a href="<?php echo e(url('/moder/dep')); ?>">Отделы</a></li>
                    <li><a href="<?php echo e(url('/moder/genre')); ?>">Жанры</a></li>
                </ul>
